...
<p>
Bikeshare stations vary drastically in terms of their social and built environment contexts given a wide range in population, retail, and employment density; a diversity of building, road, and intersection types; and variable pedestrian and bicycle facility and quality surrounding stations. Given this, it is helpful to develop a station typology to group similar stations and make observations both within and across station types to understand how different classes of bike stations perform and why. Below we explain the built environment variables we used to characterize different station types as well as the reasons for selecting them.
</p>
...
<p>
By grouping ridership by station type, we can see that stations that fall under “Residential - Low Transit Access” consistently have lower ridership across the years, which is expected given this station type’s inaccessibility to BART. Moreover, we can see several consistently high-performing outliers with the bikeshare stations on UC Berkeley’s campus (BK-D10, BK-E9-1), and several BART bikeshare stations, such as MacArthur BART and Downtown Berkeley BART (OK-F4, BK-D7-1). The high volume of ridership seen at Downtown Berkeley and MacArthur BART stations (beyond even that of comparable BART stations) may be attributable to their locations in popular and highly concentrated restaurant districts. Although we did not capture it in our clustering, previous literature confirms that universities and a high concentration of restaurants are points of interest that have significant positive effect on ridership (Guo et. al. 2022, Faghih-Imani et. al. 2014).
</p>
